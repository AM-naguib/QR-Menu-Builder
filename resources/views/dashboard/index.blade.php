            ...
            <div class="card border-0 bg-yellow-100 shadow">
                <div class="card-header d-sm-flex flex-row align-items-center border-yellow-200 flex-0">
                    ...
                    <div class="btn-group ms-auto" role="group" aria-label="Basic example"><button type="button"
                            ...
                            class="btn btn-secondary">Year</button></div>
                </div>
        ...
        <div class="col-12 col-xxl-4 mb-4">
            <div class="card border-0 shadow">
                <div class="card-header border-bottom">
                    <h2 class="fs-5 fw-bold mb-1">Weekly Sales</h2><small>28 Daily Avg.</small>
                </div>
                <div class="card-body text-center py-4 py-xl-5">
                    <h3 class="display-3 fw-extrabold mb-0">$456,678</h3>
                    <p>Total Themesberg Sales</p><a href="#"
                        class="btn btn-primary d-inline-flex align-items-center"><svg class="icon icon-xxs me-2"
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                            <div class="row align-items-center">
                                <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                            alt="Image placeholder"
                                            src="{{ asset('assets') }}/img/team/profile-picture-1.jpg"></a></div>
                                <div class="col-auto px-0">
                                    <h4 class="fs-6 text-dark mb-0"><a href="#">Chris Wood</a></h4><span
                                        class="small">Graphic Designer</span>
                                </div>
                        ...
                        <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                            <div class="row align-items-center">
                                <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                            alt="Image placeholder"
                                            src="{{ asset('assets') }}/img/team/profile-picture-3.jpg"></a></div>
                                <div class="col-auto px-0">
                                    <h4 class="fs-6 text-dark mb-0"><a href="#">Bonnie Green</a></h4><span
                                        class="small">Web Developer</span>
                                </div>
                        ...
                        <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                            <div class="row align-items-center">
                                <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                            alt="Image placeholder"
                                            src="{{ asset('assets') }}/img/team/profile-picture-2.jpg"></a></div>
                                <div class="col-auto px-0">
                                    <h4 class="fs-6 text-dark mb-0"><a href="#">Chris Wood</a></h4><span
                                        class="small">React Developer</span>
                                </div>
                        ...
                        <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                            <div class="row align-items-center">
                                <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                            alt="Image placeholder"
                                            src="{{ asset('assets') }}/img/team/profile-picture-4.jpg"></a></div>
                                <div class="col-auto px-0">
                                    <h4 class="fs-6 text-dark mb-0"><a href="#">Neil Sims</a></h4><span
                                        class="small">Python Developer</span>
                                </div>
                        ...
                        <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                            <div class="row align-items-center">
                                <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                            alt="Image placeholder"
                                            src="{{ asset('assets') }}/img/team/profile-picture-5.jpg"></a></div>
                                <div class="col-auto px-0">
                                    <h4 class="fs-6 text-dark mb-0"><a href="#">Rebbeca Sas</a></h4><span
                                        class="small">UI/UX, Art Directo</span>
                                </div>
                        ...
                        <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                            <div class="row align-items-center">
                                <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                            alt="Image placeholder"
                                            src="{{ asset('assets') }}/img/team/profile-picture-6.jpg"></a></div>
                                <div class="col-auto px-0">
                                    <h4 class="fs-6 text-dark mb-0"><a href="#">Jacklyn Brown</a></h4><span
                                        class="small">UI/UX, Art Directo</span>
                                </div>
                        ...
                        <li class="list-group-item bg-transparent py-3 px-0">
                            <div class="row align-items-center">
                                <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                            alt="Image placeholder"
                                            src="{{ asset('assets') }}/img/team/profile-picture-7.jpg"></a></div>
                                <div class="col-auto px-0">
                                    <h4 class="fs-6 text-dark mb-0"><a href="#">Melinda Norrow</a></h4><span
                                        class="small">UI/UX, Art Directo</span>
                                </div>
        ...
        <div class="col-12 col-xl-7 col-xxl-8 mb-4">
            <div class="row">
                    ...
                    <div class="card border-0 shadow">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col text-end"><a href="traffic-sources.html"
                                        class="btn btn-sm btn-primary">See all</a></div>
                            </div>
                        </div>
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-gray-500">
                                            <div class="d-flex"><svg class="icon icon-xs text-success me-2"
                                                    fill="currentColor" viewBox="0 0 20 20"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd"
                ...
                <div class="col-12 col-xxl-6 mb-4">
                    <div class="card border-0 shadow">
                        <div class="card-header border-bottom d-flex align-items-center justify-content-between">
                            <h2 class="fs-5 fw-bold mb-0">Team members</h2><a href="../users.html"
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush list my--3">
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col-auto"> <a href="#" class="avatar"><img class="rounded"
                                                    alt="Image placeholder"
                                                    src="{{ asset('assets') }}/img/team/profile-picture-1.jpg"></a></div>
                                        ...
                                        <div class="col text-end"><a href="#"
                                                class="btn btn-sm btn-secondary d-inline-flex align-items-center"><svg
                                                    class="icon icon-xxs me-2" fill="currentColor" viewBox="0 0 20 20"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd"
                                                        d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z"
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col-auto"> <a href="../users.html" class="avatar"><img
                                                    class="rounded-circle" alt="Image placeholder"
                                                    src="{{ asset('assets') }}/img/team/profile-picture-2.jpg"></a></div>
                                        <div class="col-auto ms--2">
                                            <h4 class="h6 mb-0"><a href="#">Jose Leos</a></h4>
                                            <div class="d-flex align-items-center">
                                                <div class="bg-warning dot rounded-circle me-1"></div><small>In a
                                                    meeting</small>
                                            </div>
                                        </div>
                                        <div class="col text-end"><a href="#"
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col-auto"> <a href="#" class="avatar"><img
                                                    class="rounded-circle" alt="Image placeholder"
                                                    src="{{ asset('assets') }}/img/team/profile-picture-3.jpg"></a></div>
                                        <div class="col-auto ms--2">
                ...
                <div class="col-12 col-xxl-6 mb-4">
                    <div class="card border-0 shadow">
                        <div class="card-header border-bottom d-flex align-items-center justify-content-between">
                            <h2 class="fs-5 fw-bold mb-0">Progress track</h2><a href="../users.html"
                                class="btn btn-sm btn-primary">See tasks</a>
                        </div>
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-auto"><svg class="icon icon-sm text-gray-500" fill="currentColor"
                                        viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="card border-0 shadow">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center d-block d-sm-flex border-bottom pb-4 mb-4">
                                <div class="col-auto mb-3 mb-sm-0">
                                    <div class="calendar d-flex"><span class="calendar-month">Aug</span><span
                                            class="calendar-day py-2">10</span></div>
                                </div>
                                <div class="col"><a href="../calendar.html">
                                        <h3 class="h5 mb-1">Newmarket Nights</h3>
                                    </a><span>Organized by <a href="#">University of Oxford</a></span>
                                    <div class="small fw-bold">Time: 6:00AM</div><span class="small fw-bold">Place:
                                        Cambridge Boat Club, Cambridge</span>
                                </div>
                            </div>
                            <div class="row align-items-center d-block d-sm-flex border-bottom pb-4 mb-4">
                                <div class="col-auto mb-3 mb-sm-0">
                                    <div class="calendar d-flex"><span class="calendar-month">Sep</span><span
                                            class="calendar-day py-2">12</span></div>
                                </div>
                                <div class="col"><a href="../calendar.html">
                                        <h3 class="h5 mb-1">Noco Hemp Expo</h3>
                                    </a><span>Organized by <a href="#">University of Oxford</a></span>
                                    <div class="small fw-bold">Thu, 12 Sep - Sat, 18 Sep 2020</div><span
                            ...
                            <div class="row align-items-center d-block d-sm-flex border-bottom pb-4 mb-4">
                                <div class="col-auto mb-3 mb-sm-0">
                                    <div class="calendar d-flex"><span class="calendar-month">Sep</span><span
                                            class="calendar-day py-2">15</span></div>
                                </div>
                                <div class="col"><a href="../calendar.html">
                                        <h3 class="h5 mb-1">EmTech MIT Conference</h3>
                                    </a><span>Organized by <a href="#">MIT</a></span>
                                    <div class="small fw-bold">Thu, 12 Sep - Sat, 18 Sep 2020</div><span
                                        class="small fw-bold">Place: California, USA</span>
                                </div>
                            </div>
                            <div class="row d-block d-sm-flex align-items-center">
                                <div class="col-auto mb-3 mb-sm-0">
                                    <div class="calendar d-flex"><span class="calendar-month">Sep</span><span
                                            class="calendar-day py-2">28</span></div>
                                </div>
                                <div class="col"><a href="../calendar.html">
                                        <h3 class="h5 mb-1">Canadian National Exhibition (CNE)</h3>
                                    </a><span>Organized by <a href="#">University of Oxford</a></span>
                                    <div class="small fw-bold">Fri, 20 Sep - Mon, 07 Oct 2020</div><span
                                        class="small fw-bold">Place: Toronto , Canada</span>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer border-top bg-gray-50"><a
                                class="fw-bold d-flex align-items-center justify-content-center"
                                href="../calendar.html"><svg class="icon icon-xs me-2" fill="currentColor"
                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"></path>
                                    <path fill-rule="evenodd"
                                        d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z"
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                            <div>
                                <div class="h6 mb-0 d-flex align-items-center"><svg
                                        class="icon icon-xs text-gray-500 me-2" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                            ...
                            <div><a href="#" class="d-flex align-items-center fw-bold">#755 <svg
                                        class="icon icon-xs text-gray-500 ms-1" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                        ...
                        <div class="d-flex align-items-center justify-content-between border-bottom py-3">
                            <div>
                                ...
                                <div class="small card-stats">United States <svg class="icon icon-xs text-success"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                            d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z"
                                            clip-rule="evenodd"></path>
                            ...
                            <div><a href="#" class="d-flex align-items-center fw-bold">#32 <svg
                                        class="icon icon-xs text-gray-500 ms-1" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                            d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z"
                        ...
                        <div class="d-flex align-items-center justify-content-between pt-3">
                            <div>
                                ...
                                <div class="small card-stats">Computers Electronics > Technology <svg
                                        class="icon icon-xs text-success" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                            d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z"
                                            clip-rule="evenodd"></path>
                            ...
                            <div><a href="#" class="d-flex align-items-center fw-bold">#11 <svg
                                        class="icon icon-xs text-gray-500 ms-1" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                            d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z"
                ...
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body py-4">
                                ...
                                <div class="progress-wrapper">
                                    <div class="progress-info">
                                        <div class="h6 mb-0">United States <span
                                                class="text-gray-500 font-small">(272.109)</span></div>
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-auto"> <a href="#" class="image image-xs rounded-circle"><img
                                        alt="Image placeholder"
                                        src="https://demo.themesberg.com/volt-pro/assets/img/flags/canada.svg"></a>
                            </div>
                            <div class="col">
                                <div class="progress-wrapper">
                                    <div class="progress-info">
                                        <div class="h6 mb-0">Canada <span
                                                class="text-gray-500 font-small">(160.064)</span></div>
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-auto"> <a href="#" class="image image-xs rounded-circle"><img
                                        alt="Image placeholder"
                                        src="https://demo.themesberg.com/volt-pro/assets/img/flags/germany.svg"></a>
                            </div>
                            <div class="col">
                                <div class="progress-wrapper">
                                    <div class="progress-info">
                                        <div class="h6 mb-0">Germany <span
                                                class="text-gray-500 font-small">(120.048)</span></div>
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-auto"> <a href="#" class="image image-xs rounded-circle"><img
                                        alt="Image placeholder"
                                        src="https://demo.themesberg.com/volt-pro/assets/img/flags/france.svg"></a>
                            </div>
                            <div class="col">
                                <div class="progress-wrapper">
                                    <div class="progress-info">
                                        <div class="h6 mb-0">France <span
                                                class="text-gray-500 font-small">(100.048)</span></div>
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-auto"> <a href="#" class="image image-xs rounded-circle"><img
                                        alt="Image placeholder"
                                        src="https://demo.themesberg.com/volt-pro/assets/img/flags/japan.svg"></a>
                            </div>
                            <div class="col">
                                <div class="progress-wrapper">
                                    <div class="progress-info">
                                        <div class="h6 mb-0">Japan <span class="text-gray-500 font-small">(56.022)</span>
                                        </div>
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-auto"> <a href="#" class="image image-xs rounded-circle"><img
                                        alt="Image placeholder"
                                        src="https://demo.themesberg.com/volt-pro/assets/img/flags/italy.svg"></a>
                            </div>
                            <div class="col">
                                <div class="progress-wrapper">
                                    <div class="progress-info">
                                        <div class="h6 mb-0">Italy <span class="text-gray-500 font-small">(48.019)</span>
                                        </div>
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-auto"> <a href="#" class="image image-xs rounded-circle"><img
                                        alt="Image placeholder"
                                        src="https://demo.themesberg.com/volt-pro/assets/img/flags/netherlands.svg"></a>
                            </div>
                            <div class="col">
                                <div class="progress-wrapper">
                                    <div class="progress-info">
                                        <div class="h6 mb-0">Netherlands <span
                                                class="text-gray-500 font-small">(40.016)</span></div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto"> <a href="#" class="image image-xs rounded-circle"><img
                                        alt="Image placeholder"
                                        src="https://demo.themesberg.com/volt-pro/assets/img/flags/sweden.svg"></a>
                            </div>
                            <div class="col">
                                <div class="progress-wrapper">
                                    <div class="progress-info">
                                        <div class="h6 mb-0">Sweden <span class="text-gray-500 font-small">(26.016)</span>
                                        </div>
                    ...
                    <div class="card-footer bg-gray-50 border-top text-center"><a
                            class="fw-bold d-flex align-items-center justify-content-center" href="../calendar.html"><svg
